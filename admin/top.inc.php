         ...
         <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
               ...
               <!-- <li class="menu-item-has-children dropdown">
                     <a href="banner.php" > Home Banner</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="new_arrival.php" > New Arrival</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="best_seller.php" > Best Seller Prodcuts</a>
                  </li> -->
               <li class="menu-item-has-children dropdown">
               ...
               <li class="menu-item-has-children dropdown">
                  <a href="gst.php">Manage GST</a>
               </li>
               <li class="menu-item-has-children dropdown">
                  <a href="brand.php">Manage Brand</a>
               </li>
               <li class="menu-item-has-children dropdown">
                  <a href="brand_count.php">Brand Count</a>
               </li>
               <li class="menu-item-has-children dropdown">
                  <a href="banner.php">Manage Banner</a>
               </li>
               <li class="menu-item-has-children dropdown">
                  <a href="manage_coupon_master.php">Coupon Code</a>
               </li>
