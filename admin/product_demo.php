...
while($row = mysqli_fetch_assoc($res)){
	...
	$sub_cat_row = mysqli_fetch_assoc(mysqli_query($con,"select * from sub_categories where id = '$sub_categories_id' "));
	 $sub_categories = $sub_cat_row['sub_categories'];

	$products_arr += ['sub_categories' => $sub_categories];
	echo "<pre>";
