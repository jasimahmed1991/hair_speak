...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			move_uploaded_file($_FILES['image']['tmp_name'],SUB_CATEGORY_IMAGE_SERVER_PATH.$image);
			mysqli_query($con,"insert into sub_categories(categories_id,sub_categories,image,status) values('$categories','$sub_categories','$image','1')");
		}
		?>
        <script type="text/javascript">;
                window.location.href = 'sub_categories.php';
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Sub Categories</strong><small> / <a href="sub_categories.php">Back</a> </small></div>
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Upload Sub Category Image</label>
