...
$brand_id = $_GET['id'];
if($brand_id>0){
	$products_sql = "select * from product where brand_id = $brand_id $sort_order ";
        ...
        <div class="container">
            <div class="products-filter-top">
                ...
                <form id="price-filter">
                    <label>Sort By:</label>
                    <select name="filter" id="Filter1" onchange="sort_product_brand_drop('<?php echo $brand_id?>','<?php echo SITE_PATH?>')" >
